...
export default function LoginPages() {
  return (
    <section className="flex flex-col bg-[url('/img/login-back.png')]">
      ...
      <div className="">
        <div className="bg-gray-200 rounded-t-4xl p-10 flex flex-col">
          ...
          <div className="flex flex-col gap-6 my-4">
            ...
            <p className="text-blue-900 underline font-medium">
              <a href="">Forgot Password?</a>
            </p>
          </div>
          <div className="flex flex-col gap-4">
            <ButtonLarge text="Login" link="/dashboard" />
            ...
            <p className="text-center text-sm">
              ...
              <a href="/signup" className="text-blue-900 font-medium">
                Sign up
              </a>
            </p>
          </div>
